...
> (2026-07-10) as [`packages/concierge`](https://github.com/dtch1997/arsenal/tree/main/packages/concierge),
> history preserved. Install from there:
> `pip install "git+https://github.com/dtch1997/arsenal#subdirectory=packages/concierge"`.
